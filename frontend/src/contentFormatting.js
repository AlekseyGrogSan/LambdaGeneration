...
const toTelegramLikeCodeBlock = (lang, code) => {
    ...
    return `<table class="tg-code-block code-block-table" data-language="${escapeHtml(language)}" style="width: 100%; background: var(--ui-c36); border-radius: 8px; border: 1px solid var(--ui-c192); border-collapse: separate; border-spacing: 0; margin: 14px 0; overflow: hidden; table-layout: fixed;"><thead><tr><th style="padding: 2px 6px; background: var(--ui-c30); color: var(--ui-c199); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 11px; text-align: left; font-weight: bold; border-bottom: 1px solid var(--ui-c192); user-select: none;">${escapeHtml(languageLabel)}</th></tr></thead><tbody><tr><td style="padding: 10px; overflow-x: auto;"><pre style="margin: 0; white-space: pre-wrap !important; word-wrap: break-word; background: transparent;"><code class="language-${escapeHtml(language)}" style="font-family: Consolas, monospace; font-size: 14px; background: transparent !important; padding: 0 !important; border: none !important;">${escapeHtml(codeText)}</code></pre></td></tr></tbody></table>`;
};
