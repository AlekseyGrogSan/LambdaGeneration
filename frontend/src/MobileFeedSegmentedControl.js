    ...
    return (
        <Box
            ...
            sx={{
                ...
                minHeight: 48,
                backgroundColor: 'color-mix(in oklab, var(--surface-panel) 86%, transparent)',
        ...
        >
            <Box
                ...
                sx={{
                    ...
                    boxShadow: '0 8px 14px color-mix(in oklab, var(--accent-500) 28%, transparent)',
            ...
            <Box
                ...
                sx={{
                    ...
                    color: isRandom ? 'var(--accent-contrast)' : 'var(--text-primary)',
                    fontWeight: 800,
                    fontSize: '0.9rem',
                    textAlign: 'center',
